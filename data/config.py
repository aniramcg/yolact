...
my_custom_dataset = dataset_base.copy({
    ...
    'train_images': '/content/drive/My Drive/TFG/TFG MARINA CALZADA/clean_data/YOLACT/train.json',
    'train_info':   '/content/drive/My Drive/TFG/TFG MARINA CALZADA/clean_data/YOLACT/train_labels.json',

    'valid_images': '/content/drive/My Drive/TFG/TFG MARINA CALZADA/YOLACT/test.json',
